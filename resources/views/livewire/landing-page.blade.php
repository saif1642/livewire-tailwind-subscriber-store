    ...
    >
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex flex-col w-1/3 items-start">
                <h1 class="text-white font-bold text-5xl leading-tight mb-4">Generic landing page to subscribe</h1>
                <p class="text-indigo-200 text-xl mb-20">We are just exploring <span class="font-bold underline">TALL</span> stack. Would you mind subscribing?</p>
                <x-button 
        ...
        <x-modal class="bg-green-500"  trigger="showSuccess">
            <p class="animate-pulse text-white text-5xl font-extrabold text-center">&check;</p>
